...
\begin{mdframed}[backgroundcolor=jhublue, linewidth=0pt,
  innertopmargin=10pt, innerbottommargin=10pt,
  innerleftmargin=14pt, innerrightmargin=14pt]
{\color{white}\bfseries\large JOHNS HOPKINS UNIVERSITY}\\[2pt]
{\color{white}\normalsize Net Zero Industrial Policy Lab $\cdot$ Department of Political Science}\\[2pt]
{\color{white}\small Baltimore, MD 21218, USA $\quad|\quad$ \texttt{ovalles1@jhu.edu}}
\end{mdframed}
